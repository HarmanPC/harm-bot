...
class DebateGame extends Rooms.botGame {
    constructor (room, arg) {
        ...
        if (this.args[0].toLowerCase() == "1v1") {
			this.sendRoom(`A Debate is starting between ${this.args[1].split("vs")[0].trim()} and ${this.args[1].split("vs")[1].trim()}!`);
